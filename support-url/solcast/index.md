...
We're here to help you get the most out of Solcast. Browse the topics below, or reach out directly if you can't find what you need.

## Getting Started

### How do I set up Solcast?

Launch the app and a Welcome screen appears. Grant location permission when prompted (or skip and add locations manually). Your personalized dashboard loads automatically with weather data, outfit recommendations, and your daily briefing. Open Settings (gear icon, top right) to configure your preferences.
...
Up to 10 locations. Switch between them using the location picker on the dashboard, or search for cities manually without granting location permission.
...
### What data does Solcast collect?
...
Make sure you've granted Solcast location access in Settings > Privacy & Security > Location Services > Solcast. Try restarting the app or toggling location permission off and on.

### The app is crashing

Make sure you're running the latest version of Solcast from the App Store, then try restarting your device. If crashes persist, please contact us with your device model and iOS version.
...
Can't find your answer above? Email us at [bartlettbutter@gmail.com](mailto:bartlettbutter@gmail.com) and we'll get back to you as soon as possible.
