...
The model works best with clear, well-lit photos where the dog is the main subject. Try taking the photo from a different angle or in better lighting. Mixed-breed dogs may show the closest matching breed.
...
Make sure you've granted Barkpedia camera access in **Settings > Barkpedia > Camera**. If the issue persists, try restarting the app.

### The app is crashing

Please make sure you're running the latest version of Barkpedia from the App Store. If the problem continues, try restarting your device.
