...
- **Day-by-day itineraries** — Organize destinations, activities, notes, and timing for each day.
...
- **Live flight status** — On Time, Delayed, Cancelled, Landed, and In Air badges update automatically with times in each airport's local timezone.
- **One-tap flight verification** — Enter a flight number and date to auto-fill route, airline, and schedule details.
...
- **Public holidays at a glance** — Holidays for your destination country are highlighted so you can plan around closures.
...
- **Location search** — Find hotels, restaurants, and attractions near your destination with auto-fill and map preview.
