...
The App does not access your device's GPS location or track your movements.

When you add a destination or search for places (hotels, restaurants, points of interest), your search queries are sent to Apple's servers via MapKit to return results. City names are also sent to Apple for geocoding and weather data retrieval. Country codes are sent to Nager.Date to retrieve public holiday information.
